...
<div id="wrapper">
    <main id="main" class="">
        ...
        <div id="content" role="main" class="content-area">
                        ...
                        <section class="section dark" id="section_192431142">
          ...
          <div id="page-header-1363219249" class="page-header-wrapper">
        ...
        <div class="text-center"><div class="is-divider divider clearfix" style="margin-top:0.7em;margin-bottom:0.7em;max-width:19%;height:2px;background-color:rgb(255, 255, 255);"></div></div><!-- .divider -->
                </div><!-- .section-content -->
        ...
        #section_192431142 .section-bg-overlay {
          background-color: rgba(0, 0, 0, 0.8);
        }
        #section_192431142 .section-bg.bg-loaded {
          background-image: url(https://ecomsexpert.com/wp-content/uploads/2021/03/supply-chain.png);
        }
        </style>
            </section>

            <section class="section" id="section_224746315">
                <div class="bg section-bg fill bg-fill bg-loaded">
        ...
        <div class="row row-large align-middle align-center" id="row-188528603">
        <div class="col medium-6 small-12 large-6"><div class="col-inner text-center">
        <p></p>
        <h2>Section with content right</h2>
