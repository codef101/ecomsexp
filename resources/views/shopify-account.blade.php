    ...
    <div id="wrapper">
        ...
        <main id="main" class="">
            ...
            <div id="content" role="main" class="content-area">
                            ...
                            <section class="section dark" id="section_1630801838">
              ...
              <div id="page-header-533358010" class="page-header-wrapper">
            ...
            <div class="row row-collapse align-center" id="row-204641348">
            <div class="col small-12 large-12"><div class="col-inner text-center">
            <a data-animate="fadeInUp" class="button secondary is-gloss is-larger" data-animated="true">
                <span>Get free counsaltation</span>
              </a>
            ...
            #section_1630801838 .section-bg-overlay {
              background-color: rgba(0, 0, 0, 0.8);
            }
            #section_1630801838 .section-bg.bg-loaded {
              background-image: url(https://ecomsexpert.com/wp-content/uploads/2021/02/improve-account-performance-analytics-data-ss-1920.jpg);
            }
            </style>
                </section>

                <section class="section" id="section_88345004">
                    <div class="bg section-bg fill bg-fill bg-loaded">
            ...
            <div class="row row-small align-middle" id="row-2080164258">
            <div class="col medium-6 small-12 large-6"><div class="col-inner">
              <div id="page-header-1057545206" class="page-header-wrapper">
            ...
            <p>Shopify store is ideal for all business including small medium and for startups. eComsExpert is certified in setup design and development. Our skilled team will help you to start, refresh and grow their online business as well as migrate your business from one platform to another. Our professional team of experts will provide you integration and support.</p>
            <p>We have decades of experience working in Shopify and have built a new and optimized existing one.</p>
            <h2>Our services includes</h2>
            <ul>
            <li class="bullet-arrow">Shopify store setup</li>
            <li class="bullet-arrow">Our services includes</li>
            <li class="bullet-arrow">Adjust your theme</li>
            <li class="bullet-arrow">Setup conversion tracking</li>
            <li class="bullet-arrow">Listing optimization</li>
            </ul>
            </div></div>
            <div class="col medium-6 small-12 large-6"><div class="col-inner">
                <div class="img has-hover x md-x lg-x y md-y lg-y" id="image_545599016">
                                            <div class="img-inner dark">
                        <img width="1020" height="574" src="https://ecomsexpert.com/wp-content/uploads/2021/02/improve-account-performance-analytics-data-ss-1920-1024x576.jpg" class="attachment-large size-large" alt="" loading="lazy" srcset="https://ecomsexpert.com/wp-content/uploads/2021/02/improve-account-performance-analytics-data-ss-1920-1024x576.jpg 1024w, https://ecomsexpert.com/wp-content/uploads/2021/02/improve-account-performance-analytics-data-ss-1920-300x169.jpg 300w, https://ecomsexpert.com/wp-content/uploads/2021/02/improve-account-performance-analytics-data-ss-1920-768x432.jpg 768w, https://ecomsexpert.com/wp-content/uploads/2021/02/improve-account-performance-analytics-data-ss-1920-1536x864.jpg 1536w, https://ecomsexpert.com/wp-content/uploads/2021/02/improve-account-performance-analytics-data-ss-1920.jpg 1920w" sizes="(max-width: 1020px) 100vw, 1020px">
                                </div>
            ...
            #section_88345004 {
              ...
              padding-bottom: 50px;
                ...
                <section class="section" id="section_353189641">
                    <div class="bg section-bg fill bg-fill bg-loaded">
              ...
              <div id="page-header-253348832" class="page-header-wrapper">
              <div class="page-title light simple-title">
            ...
            <div class="row row-small" id="row-96973618">

            <div class="col medium-6 small-12 large-6"><div class="col-inner">

            <div class="accordion" rel="">

            <div class="accordion-item"><a href="#" class="accordion-title plain"><button class="toggle"><i class="icon-angle-down"></i></button><span>Question 1</span></a><div class="accordion-inner">

            Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.

            </div></div>
            <div class="accordion-item"><a href="#" class="accordion-title plain"><button class="toggle"><i class="icon-angle-down"></i></button><span>Question 2</span></a><div class="accordion-inner">

            Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.

            </div></div>
            <div class="accordion-item"><a href="#" class="accordion-title plain"><button class="toggle"><i class="icon-angle-down"></i></button><span>Question 3</span></a><div class="accordion-inner">
