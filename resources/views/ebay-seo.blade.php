    ...
    <div id="wrapper">
        ...
        <main id="main" class="">
            ...
            <div id="content" role="main" class="content-area">
                            ...
                            <section class="section dark" id="section_80010145">
              ...
              <div id="page-header-75954632" class="page-header-wrapper">
            ...
            #section_80010145 .section-bg-overlay {
              background-color: rgba(0, 0, 0, 0.8);
            }
            #section_80010145 .section-bg.bg-loaded {
              background-image: url(https://ecomsexpert.com/wp-content/uploads/2021/03/ebay-seo.jpg);
            }
            </style>
                </section>

                <section class="section" id="section_1571955228">
                    <div class="bg section-bg fill bg-fill bg-loaded">
              ...
              <div id="page-header-179585511" class="page-header-wrapper">
            ...
            <div class="row row-small" id="row-1879474904">
